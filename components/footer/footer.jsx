      ...
      >
        <div className="flex flex-col items-start h-auto justify-between gap-16 w-2/4 max-lg:w-full pr-10 max-sm:pr-0">
          <div className="flex flex-col text-lg items-start  justify-between gap-10 ">
            <a href="/">
              <img src="https://yaqeenuz.wordpress.com/wp-content/uploads/2024/07/logo-orig.png" className="w-36" alt="Yaqeen-logo" />
            </a>
          ...
          <p style={{ color: "#696969" }}>© Yaqeen. Barcha huquqlar himoyalangan 2024.</p>
        </div>
